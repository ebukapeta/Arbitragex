  ...
  return (
    <>
      ...
      <div className="bg-gray-900 border border-gray-700 rounded-2xl overflow-hidden mb-4">
        ...
        {/* ── Desktop table (≥ sm) — single table, scrollable tbody ──────── */}
        <div className="hidden sm:block overflow-x-auto">
          <table
            className="w-full text-xs"
            style={{ tableLayout: 'fixed', minWidth: '1100px', borderCollapse: 'collapse' }}
          >
            {/* colgroup locks every column to exact same width for head + body */}
            <colgroup>
              <col style={{ width: '36px'  }} />{/* # */}
              <col style={{ width: '52px'  }} />{/* Base */}
              <col style={{ width: '100px' }} />{/* Pair */}
              <col style={{ width: '90px'  }} />{/* Buy Exch */}
              <col style={{ width: '100px' }} />{/* Buy Price */}
              <col style={{ width: '90px'  }} />{/* Sell Exch */}
              <col style={{ width: '100px' }} />{/* Sell Price */}
              <col style={{ width: '80px'  }} />{/* Gross */}
              <col style={{ width: '90px'  }} />{/* Net Profit */}
              <col style={{ width: '44px'  }} />{/* W/D */}
              <col style={{ width: '44px'  }} />{/* Dep */}
              <col style={{ width: '110px' }} />{/* Chain */}
              <col style={{ width: '80px'  }} />{/* Buy 24V */}
              <col style={{ width: '80px'  }} />{/* Sell 24V */}
              <col style={{ width: '60px'  }} />{/* Age */}
              <col style={{ width: '80px'  }} />{/* Execute */}
            </colgroup>
            <thead style={{ display: 'table', width: '100%', tableLayout: 'fixed' }}>
              <tr className="bg-gray-800/90 border-b border-gray-700/60 text-gray-400">
                ...
                <th className="text-right  py-2.5 px-2 font-semibold whitespace-nowrap">
            ...
            {/* tbody scrolls vertically — display:block enables overflow-y */}
            <tbody
              style={{
                display:   'block',
                overflowY: 'auto',
                overflowX: 'hidden',
                maxHeight: `${TABLE_MAX_H_DESK}px`,
              }}
            >
                {sorted.map((opp, idx) => {
                  const canExecute = opp.chainCompatible && opp.withdrawalEnabled && opp.depositEnabled;
